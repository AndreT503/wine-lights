...
const FAKE_SVGS = {
  wineLights: '<svg><path id="wineLights" name="wineLights"></path></svg>',
}
...
export class MatIconRegistryFake {
  ...
  addSvgIcon(iconName: string, url: SafeResourceUrl): this {
    // this.addSvgIcon('wineLights', 'wineLights.svg')
    return this
  }

  getNameSvgIcon(name: string, namespace: string = ''): Observable<SVGElement> {
    return of(this._svgElementFromString(FAKE_SVGS.wineLights))
  }
